...
int main(int argc, char *argv[])
{
    ...
    gtk_box_pack_start(GTK_BOX(hbox1), g1_button, TRUE, TRUE, 2);
    gtk_box_pack_start(GTK_BOX(hbox1), g2_button, TRUE, TRUE, 2);
    gtk_box_pack_start(GTK_BOX(hbox1), r1_button, TRUE, TRUE, 2);
    gtk_box_pack_start(GTK_BOX(hbox1), r2_button, TRUE, TRUE, 2);
